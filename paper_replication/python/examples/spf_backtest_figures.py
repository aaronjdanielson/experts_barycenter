...
ROOT    = Path(__file__).parent.parent.parent   # = paper_replication/
...
fig.savefig(FIG_DIR / "fig_bt1_scores_timeseries.pdf", bbox_inches="tight")
...
fig.savefig(FIG_DIR / "fig_bt2_score_diff.pdf", bbox_inches="tight")
...
fig.savefig(FIG_DIR / "fig_bt3_dispersion_split.pdf", bbox_inches="tight")
...
fig.savefig(FIG_DIR / "fig_bt4_scatter.pdf", bbox_inches="tight")
